...
export const MODEL_CATALOG = [
  ...
  },
  {
    ...
    description: "Full precision (model.onnx ~310MB). Needs the real fp32 file — not q8 renamed.",
    modelId: "onnx-community/Kokoro-82M-v1.0-ONNX",
    dtype: "fp32",
    devicePref: "wasm",
    sizeHint: "~310 MB",
  ...
  },
  {
    ...
    description: "Smaller q4 weights. Lower fidelity than Balanced — use q8 for best speech.",
    modelId: "onnx-community/Kokoro-82M-v1.0-ONNX",
    dtype: "q4",
    devicePref: "wasm",
    sizeHint: "~50–90 MB",
  ...
  },
  {
    ...
    description: "Earlier ONNX export. Needs its own pack + matching voices under models/.",
